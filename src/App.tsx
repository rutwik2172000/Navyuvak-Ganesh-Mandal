...
const content = {
  mr: {
    ...
    values: [
      ...
      'युवा सहभाग',
      'समाजसेवा',
      'स्वच्छ आणि सुरक्षित उत्सव'
    ],
    festivalEyebrow: 'गणेशोत्सव २०२६',
    festivalTitle: 'या वर्षीचा उत्सव खास बनवूया',
    festivalText:
      'दहा दिवसांची भक्ती, सांस्कृतिक कार्यक्रम, सामाजिक उपक्रम आणि आपल्या सर्वांचा उत्साह.',
    ...
    sevaText:
      'देणगी, स्वयंसेवा किंवा उपक्रमात सहभाग — तुमची छोटी मदत मोठा बदल घडवू शकते.',
    donate: 'देणगी द्या',
    volunteer: 'स्वयंसेवक व्हा',
    contactEyebrow: 'संपर्क',
    contactTitle: 'चला, एकत्र उत्सव साजरा करूया',
    contactText:
      'मंडळ, कार्यक्रम, देणगी किंवा स्वयंसेवा याबाबत काहीही विचारायचे असल्यास आम्हाला संदेश पाठवा.',
  ...
  hi: {
    ...
    values: [
      ...
      'युवा सहभागिता',
      'समाजसेवा',
      'स्वच्छ और सुरक्षित उत्सव'
    ],
    festivalEyebrow: 'गणेशोत्सव २०२६',
    festivalTitle: 'इस वर्ष का उत्सव खास बनाएं',
    festivalText:
      'दस दिनों की भक्ति, सांस्कृतिक कार्यक्रम, सामाजिक पहल और हम सभी का उत्साह।',
    ...
    sevaText:
      'दान, स्वयंसेवा या किसी पहल में भागीदारी — आपकी छोटी मदद बड़ा बदलाव ला सकती है।',
    donate: 'दान करें',
    volunteer: 'स्वयंसेवक बनें',
    contactEyebrow: 'संपर्क',
    contactTitle: 'आइए, उत्सव साथ मनाएं',
    contactText:
      'मंडल, कार्यक्रम, दान या स्वयंसेवा से जुड़ा कोई सवाल हो तो हमें संदेश भेजें।',
  ...
  en: {
    ...
    values: [
      ...
      'Youth participation',
      'Community service',
      'Clean & safe celebrations'
    ],
    festivalEyebrow: 'Ganeshotsav 2026',
    festivalTitle: "Make this year's celebration unforgettable",
    festivalText:
      'Ten days of devotion, cultural experiences, community initiatives and shared joy.',
    countdown: 'Festival begins',
    scheduleEyebrow: "What's on",
    scheduleTitle: 'Every day has a story',
    scheduleText:
      'Dates, timings and programmes — beautifully organized in one place.',
    sevaEyebrow: 'Seva & participation',
    sevaTitle: "Be part of Bappa's seva",
    sevaText:
      'Donate, volunteer or participate in an initiative. Every contribution helps us serve the community better.',
    donate: 'Donate now',
    volunteer: 'Become a volunteer',
    contactEyebrow: 'Contact',
    contactTitle: "Let's celebrate together",
    contactText:
      'Have a question about the mandal, events, donations or volunteering? Send us a message.',
  ...
  return (
    <div className='min-h-screen overflow-x-hidden bg-[#0a0706] text-[#f8f2e9] selection:bg-[#d49a32]/30'>
      ...
      <main>
        <section
          id='home'
          className='relative flex min-h-[850px] items-center pt-20'
        >
          ...
          <div className='relative mx-auto grid w-full max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[1.05fr_.95fr]'>
            <div className='max-w-2xl'>
              ...
              <div className='mt-9 flex flex-col gap-3 sm:flex-row'>
                <a
                  href='#festival'
                  className='group inline-flex items-center justify-center gap-2 rounded-full bg-[#d49a32] px-6 py-3.5 text-sm font-bold text-black shadow-[0_10px_40px_rgba(212,154,50,.18)] transition hover:-translate-y-0.5 hover:bg-[#efbb5b]'
                >
                  {t.primary}
                  <ArrowRight
                    size={17}
              ...
              <div className='mt-14 grid max-w-md grid-cols-2 gap-5 border-t border-white/10 pt-7'>
                {['5+', '54+'].map((n, i) => (
                  <div key={n}>
                    <p className='font-serif text-2xl font-bold text-[#f3c978]'>
                      {n}
                    </p>
            ...
            <div className='relative mx-auto w-full max-w-[520px]'>
              ...
              <div className='relative rounded-[2rem] border border-[#d49a32]/20 bg-gradient-to-br from-white/[.08] to-white/[.02] p-4 shadow-2xl backdrop-blur'>
                ...
                <div className='flex items-center justify-between px-3 pb-2 pt-4'>
                  ...
                  <div className='grid h-11 w-11 place-items-center rounded-full bg-[#d49a32]/10 text-[#e5b85d]'>
                    <Star size={18} />
                  </div>
                </div>
              </div>
        ...
        <section
          id='about'
          className='border-y border-white/5 bg-[#100b09] py-24 sm:py-28'
        >
            ...
            <div>
              ...
              <div className='mt-8 grid gap-3 sm:grid-cols-2'>
                {t.values.map((v, i) => (
                  <div
                    key={v}
                    className='flex items-center gap-3 rounded-2xl border border-white/8 bg-white/[.025] p-4'
                  >
                    <span className='grid h-9 w-9 shrink-0 place-items-center rounded-full bg-[#d49a32]/10 text-[#e7bb63]'>
                      {['✦', '◈', '✺', '✓'][i]}
                    </span>
              ...
              {[
                {
                  icon: Landmark,
                  title: 'परंपरा',
                  text: 'भक्ती आणि संस्कृतीची जपणूक'
                },
                { icon: Users, title: 'एकता', text: 'समुदायाला जोडणारा उत्सव' },
                {
                  icon: Heart,
                  title: 'सेवा',
                  text: 'समाजासाठी सकारात्मक योगदान'
                }
              ].map(({ icon: Icon, title, text }) => (
                <div
                  key={title}
                  className='group rounded-3xl border border-white/8 bg-white/[.025] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#d49a32]/25 hover:bg-white/[.04]'
                >
                  <div className='mb-5 grid h-12 w-12 place-items-center rounded-2xl border border-[#d49a32]/20 bg-[#d49a32]/10 text-[#eac06b]'>
                    <Icon size={20} />
                  </div>
                  <h3 className='font-serif text-xl font-bold text-[#f6d58d]'>
                    {title}
                  </h3>
          ...
          <div className='relative mx-auto max-w-7xl px-5 sm:px-8'>
            <div className='grid gap-8 lg:grid-cols-[1.2fr_.8fr]'>
              <div className='rounded-[2rem] border border-[#d49a32]/20 bg-gradient-to-br from-[#6f1b13]/35 to-white/[.025] p-8 sm:p-12'>
                ...
                <div className='mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4'>
                  {[
                    ...
                    >
                      <p className='font-serif text-3xl font-bold text-[#f5cf82]'>
                        {d}
                      </p>
              ...
              <div className='rounded-[2rem] border border-white/10 bg-white/[.035] p-8 sm:p-10'>
                <div className='flex items-center gap-2 text-[#e6b85f]'>
                ...
                <div className='mt-8 grid grid-cols-3 gap-3'>
                  {[
                    ...
                    <div
                      key={l}
                      className='rounded-2xl bg-black/25 p-4 text-center'
                    >
                      <p className='font-serif text-4xl font-bold'>{n}</p>
                      <p className='mt-1 text-[10px] uppercase tracking-[.18em] text-white/35'>
                        {l}
                      </p>
                    </div>
                  ))}
                ...
                <div className='mt-8 flex items-center gap-3 rounded-2xl border border-white/8 bg-black/20 p-4'>
                  <div className='grid h-11 w-11 place-items-center rounded-full bg-[#d49a32]/10 text-[#efc66f]'>
                    <Clock3 size={18} />
                  </div>
                  <div>
                    <p className='text-sm font-semibold'>19 September 2026</p>
                    <p className='text-xs text-white/40'>
                      Grand opening & Sthapana
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section id='events' className='bg-[#100b09] py-24 sm:py-28'>
          <div className='mx-auto max-w-7xl px-5 sm:px-8'>
            <div className='flex flex-col justify-between gap-5 sm:flex-row sm:items-end'>
              ...
              <a
                href='#contact'
                className='inline-flex items-center gap-2 text-sm font-semibold text-[#e8bd68]'
              >
                {t.readMore}
                <ArrowRight size={16} />
              </a>
            ...
            <div className='mt-12 grid gap-4'>
              {events.map(event => {
                ...
                return (
                  <article
                    key={event.title}
                    className='group grid gap-5 rounded-2xl border border-white/8 bg-white/[.025] p-5 transition hover:border-[#d49a32]/25 hover:bg-white/[.04] sm:grid-cols-[90px_1fr_auto] sm:items-center'
                  >
                    <div className='flex items-center gap-3 sm:block'>
                      <p className='font-serif text-4xl font-bold text-[#f1c873]'>
                        {event.day}
                      </p>
                      <p className='text-[10px] font-bold tracking-[.25em] text-white/35'>
                        {event.month}
                    ...
                    <div className='flex items-center gap-4'>
                      <div className='hidden h-11 w-11 place-items-center rounded-full bg-[#d49a32]/10 text-[#e7b95f] sm:grid'>
                        <Icon size={18} />
                      </div>
                      <div>
                    ...
                    <span className='w-fit rounded-full border border-[#d49a32]/20 bg-[#d49a32]/5 px-3 py-1 text-[10px] font-bold uppercase tracking-[.18em] text-[#e8bd68]'>
                      {event.tag}
                    </span>
                  </article>
                )
            ...
            <div className='relative overflow-hidden rounded-[2.25rem] border border-[#d49a32]/20 bg-gradient-to-br from-[#701c13] to-[#21100b] p-8 sm:p-12 lg:p-16'>
              ...
              <div className='relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end'>
                ...
                <div className='flex flex-col gap-3 sm:flex-row lg:flex-col'>
                  <a
                    href='#contact'
                    className='inline-flex items-center justify-center gap-2 rounded-full bg-[#f0c76d] px-6 py-3.5 text-sm font-bold text-black hover:bg-[#ffe09a]'
                  >
                    <Heart size={16} /> {t.donate}
                  </a>
                  <a
                    href='#contact'
                    className='inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3.5 text-sm font-semibold hover:bg-white/10'
                  >
                    <Users size={16} /> {t.volunteer}
                  </a>
                </div>
              </div>
            </div>
        ...
        <section
          id='contact'
          className='border-t border-white/5 bg-[#100b09] py-24 sm:py-28'
        >
          <div className='mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[1fr_.85fr]'>
            <div>
              ...
              <div className='mt-10 grid gap-3 sm:grid-cols-2'>
                <a href='tel:+917517726476' className='contact-card'>
                  <Phone size={18} />
                  <span>
                    <b>7517726476</b>
                ...
                <div className='contact-card'>
                  <MapPin size={18} />
                  <span>
                    <b>Mandwa, Chandur Rly, Amravati</b>
                ...
                <div className='contact-card'>
                  <Clock3 size={18} />
                  <span>
                    <b>09:00 AM – 10:00 PM</b>
                    <small>Festival help desk</small>
                  </span>
                </div>
              </div>
            </div>
            <div className='rounded-[2rem] border border-white/10 bg-white/[.025] p-7 sm:p-9'>
              ...
              <p className='text-sm leading-7 text-white/45'>
                “The best celebrations are the ones that leave the community
